...
const createProduct = (data) => {
    ...
    <div class="product-card">
        ...
        ${data.draft ? `<span class="tag">Draft</span>` : ''}
            <img src="${data.images[0] || 'img/no image.png'}" alt="product-image" class="product-thumb">
        ...
        <div class="product-info">
            ...
            <span class="price">रू${data.sellPrice}</span>
            <span class="actual-price">रू${data.actualPrice}</span>
        </div>
    </div>
    `;
}
